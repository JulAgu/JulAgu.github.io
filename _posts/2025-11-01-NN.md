...
After 5 iterations we found that best parameters are \\(w_0 = 200 000, w_1 = 25, w_2= -0.15, w_3= 1 000\\). Now, **assuming that the collected samples are representative of actual market dynamics**, you can estimate the price of your tractor, or virtually, the price of any other tractor under market conditions in your region over the last year, as that is the scope of the samples.
